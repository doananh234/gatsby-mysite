...
const PrivacyPolicyPage = () => (
  <Layout>
    <SEO title="Privacy Policy" type="Organization" location="/privacy-policy/" />
    <Container>
      <h1>Privacy Policy</h1>
      <p>Effective date: November 11, 2018</p>

      <p>
        Ai Hashtags ("us", "we", or "our") operates the https://doananh234.com website and the Ai
        Hashtags mobile application (the "Service").
      </p>

      <p>
        This page informs you of our policies regarding the collection, use, and disclosure of
        personal data when you use our Service and the choices you have associated with that data.
        Our Privacy Policy for Ai Hashtags is managed through
        {' '}
...
We use Security Cookies for security purposes.
      ...
      <p>
        If you are located outside Morocco and choose to provide information to us, please note that
        we transfer the data, including Personal Data, to Morocco and process it there.
      </p>
      <p>
      ...
      <p>
        Ai Hashtags will take all steps reasonably necessary to ensure that your data is treated
      ...
      <p>
        Ai Hashtags may disclose your Personal Data in the good faith belief that such action is
        necessary to:
      </p>
      <ul>
